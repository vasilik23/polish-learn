...
import { loadBootstrap, type BootstrapData } from '../lib/api';
...
const styles = StyleSheet.create({
  ...
  task: { flexDirection: 'row', borderWidth: 1, borderRadius: 18, padding: 16, gap: 12 }, emoji: { fontSize: 25 }, taskBody: { flex: 1, gap: 4 }, taskTitle: { fontSize: 17, fontWeight: '800' }, taskCopy: { fontSize: 14, lineHeight: 20 }, meta: { fontSize: 13, fontWeight: '800' }, alert: { borderWidth: 1, borderRadius: 14, padding: 14 }, boundary: { fontSize: 12, lineHeight: 18, marginTop: 8 },
});
