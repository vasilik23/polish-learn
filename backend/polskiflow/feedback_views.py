...
def feedback(request):
    ...
    return render(request, "feedback.html", {"categories": CATEGORIES, "form": form, "error": error, "sent": request.GET.get("sent") == "1", "items": items or [], "available": items is not None}, status=400 if error else 200)
