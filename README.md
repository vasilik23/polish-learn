...
- программа C2 с восемью вертикальными темами;
...
- **Next:** поддерживать реализованную 28-дневную аналитику персональной дневной
  цели; провести пилот аудиозаписи с проверенной лицензией и добавить отдельные
