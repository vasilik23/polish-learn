...
- **Now:** редакторская выборка A1–C2, измеримый performance baseline и аудит
  ключевых сценариев по WCAG 2.2 AA. Production E2E сохранения прогресса
  закреплён; две legacy-связи чтения устранены.
