...
- недельная активность в профиле и быстрый переход от текста к SM-2-тренировке.
...
- **Now:** поддерживать реализованное восстановление доступа; провести
  редакторскую валидацию программы A1–C2; закрепить сквозной production smoke
  сценария «выполнить урок → увидеть обновление Сегодня и Заданий → проверить
  сохранённую запись». Покрытие чтений comprehension-заданиями защищено
  автоматическим тестом.
- **Next:** поддерживать реализованные 28-дневную аналитику цели и A1-пилот
  аудирования на проверенных public-domain записях; после лицензирования
  расширить аудирование до фраз и связной речи.
- **Later:** измеряемая оптимизация, публичный API и нативные мобильные клиенты.
