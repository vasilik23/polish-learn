...
- **Now:** начать C1 с темы «Стиль и регистр»; все двенадцать тем B2 уже
  наполнены, а персональный план выбирает следующие незавершённые уроки текущего
  уровня и просроченные повторения SM-2.
