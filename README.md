...
- программа B1 из восьми полных тем: от биографии и путешествий до медиа и культуры;
...
- **Now:** продолжать наполнение B1 с темы «Общество»; персональный план уже выбирает следующие
...
- **Next:** связать чтение, добавление леммы в словарь, разные упражнения и SM-2
  в единый сценарий; добавить короткое письмо B1, лицензированное аудирование и
  расширять вопросы по прочитанным текстам на A1.
- **Later:** недельная статистика, оптимизация и нативные мобильные клиенты.
