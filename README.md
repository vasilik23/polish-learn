...
- **Now:** продолжить B2 с темы «Публичная дискуссия»; первые восемь тем
  B2 уже наполнены, а персональный план выбирает следующие незавершённые уроки
  текущего уровня и просроченные повторения SM-2.
- **Next:** связать чтение, добавление леммы в словарь, разные упражнения и SM-2
  в единый сценарий — базовый маршрут уже работает для слов выбранного текста;
  добавить контекстную тренировку, лицензированное аудирование и вопросы по
  прочитанным текстам на A1.
