...
- **Now:** продолжить C1 с темы «Академическое письмо»; первые четыре темы C1 и
  все двенадцать тем B2 уже наполнены, а персональный план выбирает следующие
  незавершённые уроки и просроченные повторения SM-2.
- **Next:** путь от чтения и леммы до личного словаря и SM-2 уже включает выбор
  ...
  A1-тексты получили вопросы на понимание. Следующий крупный шаг —
  лицензированное аудирование.
