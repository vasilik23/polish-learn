...
- программа B1 из четырёх полных тем: биография, путешествия, работа и образование;
...
- **Now:** продолжать наполнение B1 с темы «Отношения»; персональный план уже выбирает следующие
