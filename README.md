...
- стартовая программа C2 с первыми двумя вертикальными темами;
...
- **Now:** добавить восстановление пароля и повторную отправку подтверждения
  email; провести редакторскую валидацию программы A1–C2; закрепить сквозной
  production smoke сценария «выполнить урок → увидеть обновление Сегодня и
  Заданий → проверить сохранённую запись».
