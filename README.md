...
- **Now:** провести редакторскую валидацию программы A1–C1; все запланированные
  темы наполнены, а размер персонального плана на день настраивается в профиле.
- **Next:** путь от чтения и леммы до личного словаря и SM-2 уже включает выбор
  ответа, обратный формат и продуктивное заполнение пропуска; все активные
  A1-тексты получили вопросы на понимание. Все оригинальные тексты можно
  озвучить системным польским голосом; следующим шагом остаётся пилот записи с
  проверенной лицензией и отдельными заданиями на слух.
- **Later:** расширенная аналитика прогресса, оптимизация и нативные мобильные
  клиенты.
