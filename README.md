...
- **Now:** продолжить B2 с темы «Экономика и потребление»; первые четыре темы
...
- **Next:** связать чтение, добавление леммы в словарь, разные упражнения и SM-2
  в единый сценарий; расширить письменную практику с B1 на B2, добавить
  лицензированное аудирование и вопросы по прочитанным текстам на A1.
