...
- начатая программа B1: две полные темы — «Биография и опыт» и «Путешествия»;
...
- **Now:** продолжать наполнение B1 с темы «Работа и развитие»; персональный план уже выбирает следующие
