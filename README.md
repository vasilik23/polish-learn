...
- программа C2 с шестью вертикальными темами;
...
- **Next:** аналитика выполнения персональной дневной цели, пилот аудиозаписи с
  проверенной лицензией и отдельные задания на понимание речи.
