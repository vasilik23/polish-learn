...
- **Now:** редакторская выборка A1–C2 и аудит ключевых сценариев по WCAG 2.2 AA.
  Production E2E сохранения прогресса и измеримый performance baseline
  закреплены; две legacy-связи чтения устранены.
